...
public class TableSorter extends DefaultTableModel {
    ...
    public TableSorter(JTable table, TableModel tableModel, JTableHeader tableHeader) {
        this(table);
    ...
    private class Row implements Comparable {
        ...
        public int compareTo(Object o) {
            ...
            for (Iterator it = sortingColumns.iterator(); it.hasNext();) {
                ...
                Object o1 = TableSorter.this.getValueAt(row1, column);
                Object o2 = TableSorter.this.getValueAt(row2, column);
