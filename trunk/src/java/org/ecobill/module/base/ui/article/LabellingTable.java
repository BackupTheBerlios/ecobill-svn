...
import org.ecobill.core.system.Persistable;
...
public class LabellingTable extends JPanel implements Internationalization, Persistable {
    ...
    /**
     * Gibt die Tabelle in der Anzeige zur�ck.
     *
    ...
    /**
     * Erzeugt eine neues Labelling Table Panel f�r Artikel.
     */
    ...
    public void renewTableModel(Article article) {
        ...
        if (article != null) {
            ...
            // der Tabelle. Dies muss gemacht werden, das sonst alle Eintr�ge die schon
            ...
            */
            for (ArticleDescription description : descriptions) {
                ...
                // F�gt den Artikel dem <code>TableModel</code> hinzu.
                Vector<Object> lineV = createVectorOfArticleDescription(description);

                dataVector.add(lineV);
            }

            // Zeichnet die Tabelle nach hinzuf�gen des Artikels neu.
            table.repaint();
            tableSP.setViewportView(table);
        }
    }
     ...
     *                    werden soll.
     * @return Gibt den <code>Vector</code> zur�ck der aus der <code>ArticleDescription</code> erzeugt wurde.
     */
    ...
    /**
     * @see org.ecobill.core.system.Persistable#persist(java.io.OutputStream)
     */
    ...
    /**
     * @see org.ecobill.core.system.Persistable#persist(java.io.InputStream)
     */
