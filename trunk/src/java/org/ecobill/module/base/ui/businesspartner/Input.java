...
import org.ecobill.module.base.domain.SystemCountry;
import org.ecobill.module.base.domain.SystemUnit;
import org.ecobill.module.base.domain.SystemCounty;
...
import org.ecobill.core.util.ComboBoxUtils;
...
/**
 * Das <code>Input</code> <code>JPanel</code> stellt die Eingabem�glichkeit f�r einen
 * Gesch�ftspartner zur Verf�gung, die restlichen Daten werden �ber weitere <code>JPanel</code>
 * angeboten.
 * <p/>
 * User: rro
 * Date: 15.07.2005
...
public class Input extends JPanel implements Internationalization {
    ...
    public void resetInput() {
        ...
        // Falls noch kein Land ausgew�hlt wurde, k�nnen auch keine Bundesl�nder
        // ausgew�hlt werden.
        try {
