...
import org.ecobill.module.base.ui.component.AbstractJasperPrintPanel;
import org.ecobill.module.base.ui.component.AbstractJasperViewerDialog;
...
public class BillViewerDialog extends AbstractJasperViewerDialog {
    ...
    /**
     * @see org.ecobill.module.base.ui.component.AbstractJasperPrintPanel#createPanelBorder()
     */
    ...
    protected void jasper(Long id) throws Exception {
        ...
        org.ecobill.module.base.domain.Address address = bp.getAddress();
        ...
        // Die Parameter, die an den <code>JasperViewer</code> �bergeben werden und zum erstellen des
        // Reports n�tig sind.
