...
import org.ecobill.util.Localizable;
...
public class ArticleDescription extends AbstractDomain implements Localizable {
    ...
    /**
     * Die f�r diese Beschreibung zugeh�rige <code>SystemLocale</code>.
     */
    private SystemLocale systemLocale;

    /**
     * Gibt die landesspezifische Beschreibung zur�ck.
     *
    ...
    /**
     * Gibt die <code>SystemLocale</code> f�r diese <code>ArticleDescription</code>
     * zur�ck.
     *
     * @return Die <code>SystemLocale</code> f�r diese <code>ArticleDescription</code>.
     */
    ...
    /**
     * Setzt die <code>SystemLocale</code> f�r diese <code>ArticleDescription</code>.
     *
     * @param systemLocale Die <code>SystemLocale</code> f�r diese
