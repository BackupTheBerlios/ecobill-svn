...
import org.ecobill.module.base.hbm.sort.OrderPositionComparator;

import java.util.*;

/**
 * Die <code>DeliveryOrder</code> ist ein Lieferschein Objekt, dem ein Gesch�ftspartner zugeordnet wird.
 ...
 * Zu jedem Lieferschein geh�rt ein <code>Set</code> von <code>ReduplicatedArticle</code>.
 * <p/>
 * User: rro
 * Date: 26.07.2005
 * Time: 19:51:39
...
public class DeliveryOrder extends AbstractDomain {
    ...
    /**
     * Der Gesch�ftspartner dem dieser Lieferschein zugeordnet werden soll.
     */
    ...
    /**
     * Gibt den zu diesem Lieferschein dazugeh�rigen <code>BusinessPartner</code>
     * zur�ck.
     *
    ...
    /**
     * Setzt den <code>BusinessPartner</code> der zu diesem Lieferschein geh�rt.
     *
    ...
    /**
     * Gibt die Lieferscheinnummer zur�ck.
     *
    ...
    /**
     * Gibt den <code>CharacterisationType</code> dieses Lieferscheines zur�ck.
     *
    ...
    /**
     * Gibt ein <code>Set</code> mit <code>ReduplicatedArticle</code> zur�ck.
     *
    ...
    /**
     * F�gt zu den Artikeln des Lieferscheines den <code>ReduplicatedArticle</code> hinzu.
     *
