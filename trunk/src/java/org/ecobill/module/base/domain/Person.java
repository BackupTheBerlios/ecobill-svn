...
/**
 * Das <code>Person</code> Objekt beinhaltet alle f�r eine Person spezifischen Daten.
 * <p/>
 * User: rro
 * Date: 21.07.2005
 * Time: 13:31:22
...
public class Person extends AbstractDomain {
    ...
    /**
     * Der Schl�ssel eines akademischen Titels.
     * <br/>
     * Bspw. "prof_dr" f�r "Prof. Dr.".
     */
    ...
    /**
     * Gibt den Schl�ssel f�r die Anrede zur�ck.
     *
     * @return Der Schl�ssel f�r die Anrede.
     */
    ...
    /**
     * Setzt den Schl�ssel f�r die Anrede.
     *
     * @param titleKey Der Schl�ssel f�r die Anrede.
     */
    ...
    /**
     * Gibt den Schl�ssel f�r die Anrede, die in Briefen verwendet wird,
     * zur�ck.
     *
     * @return Der Schl�ssel f�r die Anrede, die in Briefen verwendet wird.
     */
    ...
    /**
     * Gibt den Schl�ssel f�r den akademischen Titel zur�ck.
     *
     * @return Der Schl�ssel f�r den akademischen Titel.
     */
    ...
    /**
     * Setzt den Schl�ssel f�r den akademischen Titel.
     *
     * @param academicTitleKey Der Schl�ssel f�r den akademischen Titel.
     */
    ...
    /**
     * Gibt die Telefonnummer der Person zur�ck.
     *
    ...
    /**
     * Gibt die Telefaxnummer der Person zur�ck.
     *
    ...
    /**
     * Gibt die E-Mail Adresse der Person zur�ck.
     *
    ...
    /**
     * Gibt eine <code>AddressPanel</code> zur�ck. Diese beinhaltet bspw. Stra�e,
